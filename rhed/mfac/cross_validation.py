...
books.build_ratings(filename="ratings_tuple_std", standardize=False, withhold=2000, discard=180000)
...
data_mfact = mf.mfact(data_train["ratings"], data_train["N"], data_train["D"], \
	K, steps=max_steps, alpha=0.001, beta=0.02, epsilon=0.001, use_bias=False, filename=("mfact_%d_run_%d" % (K, run)))
